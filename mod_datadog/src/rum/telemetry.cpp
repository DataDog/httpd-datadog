...
std::shared_ptr<Counter> injection_failed(new Counter{"injection.failed", "rum",
                                                      true});
std::shared_ptr<Counter> configuration_succeed(new Counter{
    "injection.initialization.succeed", "rum", true});
std::shared_ptr<Counter> configuration_failed(new Counter{
    "injection.initialization.failed", "rum", true});
